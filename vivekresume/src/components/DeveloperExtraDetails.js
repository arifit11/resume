    ...
    render() {
        return (
            <div>
                ...
                <h5>Education</h5>
                <p className="small">Bechelors of Engineering (2006-2010)</p>
                <p className="small">Computer Science & Engineering</p>
                <p className="small">BIST Bhopal </p>
                <p className="small">70% Aggregate </p>
                <div className="clearfix"></div><br/>
